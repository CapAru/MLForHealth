...
export default function MLForBody() {
    ...
    const generatePDF = () => {
        ...
        setTimeout(() => {
            try {
                ...
                doc.text(
                    `Date: ${reportDate} | Report ID: ${reportId}`,
                    margin,
                    yPos
                );
                yPos += 10;
                ...
                const predictionText =
                    ...
                    (result.prediction === 1
                        ? "High Risk Detected"
                        : "Low Risk Detected");
                const probabilityText = `Probability: ${riskPercentage.toFixed(
                    1
                )}%`;
    ...
    const renderHealthSuggestions = (forPdf = false) => {
        ...
        if (riskLevel === "high") {
            ...
            suggestions.push(
                "✓ Maintain your current heart-healthy practices."
            );
                ...
                if (currentList.length > 0) {
                    htmlSuggestions.push(
                        <div key={`section-${index - 1}`} className="mb-4">
                            {currentHeader && (
                                <h5 className="mb-2">{currentHeader}</h5>
                            )}
        ...
        <div className="container py-5">
            ...
            <div className="text-center mb-5">
                ...
                <p className="small text-warning">
                    <strong>Note:</strong> This tool provides an estimate based
                    on common risk factors and is <strong>not</strong> a
